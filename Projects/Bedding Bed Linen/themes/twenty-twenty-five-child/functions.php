<?php
/**
 * Theme functions file for Twenty Twenty-Five Child Theme.
 */
...
wp_enqueue_script(
    ...
    // --- THIS IS THE FIX ---
    // Pass AJAX URL for 'Add to Cart' functionality (MUST run after wp_enqueue_script)
    wp_localize_script( $script_handle, 'ajax_object', array( 
